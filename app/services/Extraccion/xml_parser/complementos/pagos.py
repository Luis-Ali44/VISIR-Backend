...
def _extraer_totales(pagos: ET.Element) -> dict | None:
    ...
    if totales is None:
        return None
    return {
        "total_retenciones_iva": _float_or_none(totales.get("TotalRetencionesIVA")),
        "total_retenciones_isr": _float_or_none(totales.get("TotalRetencionesISR")),
        "total_retenciones_ieps": _float_or_none(totales.get("TotalRetencionesIEPS")),
        "total_traslados_base_iva16": _float_or_none(totales.get("TotalTrasladosBaseIVA16")),
        "total_traslados_impuesto_iva16": _float_or_none(
            totales.get("TotalTrasladosImpuestoIVA16")
        ),
        "total_traslados_base_iva8": _float_or_none(totales.get("TotalTrasladosBaseIVA8")),
        "total_traslados_impuesto_iva8": _float_or_none(totales.get("TotalTrasladosImpuestoIVA8")),
        "total_traslados_base_iva0": _float_or_none(totales.get("TotalTrasladosBaseIVA0")),
        "total_traslados_impuesto_iva0": _float_or_none(totales.get("TotalTrasladosImpuestoIVA0")),
        "total_traslados_base_iva_exento": _float_or_none(
            totales.get("TotalTrasladosBaseIVAExento")
        ),
        "monto_total_pagos": _float_or_none(totales.get("MontoTotalPagos")),
    }
