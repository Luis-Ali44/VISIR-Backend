...
class RAGConfig:
    ...
    llm_cascade_umbral_complejidad: float = 0.55
    ...
    def embedding_dimensions(self) -> int | None:
        ...
        return _EMBEDDING_DIMENSIONS.get(self.embedding_model_name) or _EMBEDDING_DIMENSIONS.get(
            model_base
        )
...
def load_config_from_env(chroma_path: str = "./chroma_db") -> RAGConfig:
    return RAGConfig(
        ...
        llm_fallback_base_url=os.getenv("LLM_FALLBACK_BASE_URL", "https://api.openai.com/v1"),
        llm_fallback_api_key=os.getenv("LLM_FALLBACK_API_KEY", ""),
        llm_fallback_model=os.getenv("LLM_FALLBACK_MODEL", "gpt-4o-mini"),
        llm_fallback_max_tokens=int(os.getenv("LLM_FALLBACK_MAX_TOKENS", "2048")),
        llm_cascade_umbral_complejidad=float(os.getenv("LLM_CASCADE_UMBRAL_COMPLEJIDAD", "0.55")),
    )
