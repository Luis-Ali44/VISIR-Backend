...
CFDIS_SINTETICOS: list[dict] = [
    {
        ...
        "conceptos": [
            {"descripcion": "Infraestructura en la nube enero 2025",
             "clave_prod_serv": "81112501", "cantidad": 1, "importe": 18965.52}
        ],
    },
    {
...

    {
        ...
        "conceptos": [
            {"descripcion": "Renovacion anual licencias software contable",
             "clave_prod_serv": "43231513", "cantidad": 5, "importe": 34310.34}
        ],
    },
    {
        ...
        "conceptos": [
            {"descripcion": "Resmas papel bond carta 500 hojas",
             "clave_prod_serv": "44121500", "cantidad": 10, "importe": 1500.00},
            {"descripcion": "Toner HP LaserJet negro",
             "clave_prod_serv": "44101803", "cantidad": 2, "importe": 1200.00},
            {"descripcion": "Articulos de oficina varios",
             "clave_prod_serv": "44121500", "cantidad": 1, "importe": 300.00},
        ],
    },
    {
        ...
        "conceptos": [
            {"descripcion": "Consultoria fiscal y contable Q2 2025",
             "clave_prod_serv": "80101500", "cantidad": 1, "importe": 31379.31}
        ],
    },
]
...
def indexar_fixtures(verbose: bool = True) -> None:
    ...
    if verbose:
        print(f"\n{'='*60}")
        print(f"  FIXTURES ORG RAG -- indexando CFDIs sinteticos")
    ...
    results_meta = store.collection.get(
        where={"id_organizacion": {"$eq": ID_ORG_PRUEBA}},
        include=["metadatas"],
    )
    ...
    if verbose:
        print("  Verificación OK: filenames y conteo de chunks coinciden con el dataset de evaluación.\n")
